    ...
    return (
        <>
            <footer className="bg-[#2A2A2A]">
                <div className="grid grid-cols-1 lg:grid-cols-2 px-8 md:px-36 py-14 md:py-28">
                ...
                <div className="terms-and-conditions flex flex-col md:flex-row px-8 md:px-36 py-10 md:py-14 justify-between items-center">
                    ...
                    <div className="flex space-x-10 text-sm text-white opacity-75 pt-4 md:pt-0 md:pr-24">
