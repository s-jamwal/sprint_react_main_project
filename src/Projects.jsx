      ...
      <div className="bg-white px-4 md:px-20 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="overflow-hidden rounded-xl">
            <img className="w-full" src="https://sprintdigital.com.au/themes/sprint-digital/assets/images/pages/case-studies/snap-fitness/projects-snap-min.png" alt="Snap Fitness" />
          ...
          <div className="overflow-hidden rounded-xl">
            <img className="w-full mt-8 md:mt-0" src="https://sprintdigital.com.au/themes/sprint-digital/assets/images/pages/case-studies/rochele/projects-rochele-min.png" alt="Rochele Painting" />
            <div className="px-6 py-4">
              ...
              <br/>
              <a href="https://sprintdigital.com.au/case-studies/rochele-painting" className="text-2xl text-gray-900 underline">Read Case Study</a>
            </div>
          </div>
          <div className="overflow-hidden rounded-xl">
            <img className="w-full mt-8 md:mt-0" src="https://sprintdigital.com.au/themes/sprint-digital/assets/images/pages/case-studies/go-turf/projects-goturf-min.png" alt="Goturf" />
            <div className="px-6 py-4">
          ...
          <div className="overflow-hidden rounded-xl">
            <img className="w-full mt-8 md:mt-0" src="https://sprintdigital.com.au/themes/sprint-digital/assets/images/pages/case-studies/pure-grain/projects-puregrain-min.png" alt="Pure Grain" />
            <div className="px-6 py-4">
